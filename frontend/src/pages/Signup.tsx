    ...
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        <div className="rounded-2xl border p-8"
          ...
          <h1 className="font-syne font-black text-2xl mb-1" style={{ color: "hsl(var(--foreground))" }}>Create your account</h1>
          <p className="text-sm mb-8" style={{ color: "hsl(var(--muted-foreground))" }}>Start your free business assessment today</p>
          ...
          <p className="mt-6 text-center text-sm" style={{ color: "hsl(var(--muted-foreground))" }}>
            ...
            <Link to="/login" className="font-semibold" style={{ color: "hsl(var(--cyan))" }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
